...
class GenTaskCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for carbon_tile in carbon_tiles:
            tile_base_name = rsgislib.tools.filetools.get_file_basename(carbon_tile).replace("_soc_0_100cm_fill", "")
            ...
            gmw_ext_img = os.path.join(kwargs['gmw_ext_dir'], "{}_gmw_core.kea".format(tile_base_name))

            out_file = os.path.join(kwargs['out_path'], "{}_total_soil_c_stats.json".format(tile_base_name))
    ...
    def run_gen_commands(self):
        ...
        self.gen_command_info(carbon_tiles='/home/pete/Documents/gmw_v3_soil_total_carbon/data/gmw_v2_soil_carbon_data/soc_0_100m_gmw_tiles_filled/*.tif',
                              ...
                              gmw_ext_dir='/home/pete/Documents/gmw_v3_soil_total_carbon/data/gmw_v3_extent/gmw_core_srtm_rasters',
                              out_path='/home/pete/Documents/gmw_v3_soil_total_carbon/data/gmw_v2_soil_carbon_data/out_stats/total_soil_c/tile_stats_core')
