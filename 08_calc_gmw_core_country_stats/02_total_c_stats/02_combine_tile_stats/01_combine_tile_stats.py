...
stats_tiles = glob.glob('/home/pete/Documents/gmw_v3_soil_total_carbon/data/gmw_v2_soil_carbon_data/out_stats/total_c/tile_stats_core/*.json')
...
rsgislib.tools.utils.write_dict_to_json(tile_stats_lut, 'country_total_c_stats.json')

df_stats = pandas.DataFrame.from_dict(out_data)
df_stats.to_feather("country_total_c_stats.feather")
df_stats.to_csv("country_total_c_stats.csv")
xls_writer = pandas.ExcelWriter("country_total_c_stats.xlsx", engine='xlsxwriter')
df_stats.to_excel(xls_writer, sheet_name='tot_c')
xls_writer.save()

rsgislib.tools.utils.write_dict_to_json(tile_hist_lut, "country_total_c_hists.json")
...
xlsx_writer = pandas.ExcelWriter("glb_total_c_hist.xlsx", engine='xlsxwriter')
df_hist_stats.to_excel(xlsx_writer, sheet_name='tot_c_hist')
xlsx_writer.save()
