...
class GenTaskCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for carbon_tile in carbon_tiles:
            ...
            out_file = os.path.join(kwargs['out_path'], "{}_total_c_stats.json".format(tile_base_name))
    ...
    def run_gen_commands(self):
        ...
        self.gen_command_info(carbon_tiles='/home/pete/Documents/gmw_v3_soil_total_carbon/data/gmw_v2_soil_carbon_data/total_carbon_tiles/gmw_2020_total_c/*.tif',
                              ...
                              out_path='/home/pete/Documents/gmw_v3_soil_total_carbon/data/gmw_v2_soil_carbon_data/out_stats/total_c/tile_stats_core')
